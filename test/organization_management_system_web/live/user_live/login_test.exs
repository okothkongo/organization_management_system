defmodule OrganizationManagementSystemWeb.UserLive.LoginTest do
  ...
  describe "user login - magic link" do
    test "sends magic link email when user exists", %{conn: conn} do
      ...
      assert OrganizationManagementSystem.Repo.get_by!(
               OrganizationManagementSystem.Accounts.UserToken,
               user_id: user.id
             ).context ==
               "login"
    end
