defmodule OrganizationManagementSystem.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `OrganizationManagementSystem.Accounts` context.
  """
  ...
  def override_token_authenticated_at(token, authenticated_at) when is_binary(token) do
    OrganizationManagementSystem.Repo.update_all(
  ...
  def generate_user_magic_link_token(user) do
    ...
    OrganizationManagementSystem.Repo.insert!(user_token)
